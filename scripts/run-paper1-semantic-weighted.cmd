...
set "CONFIG=%REPO_ROOT%\configs\paper1\asl_matrix_q0_semantic_weighted_qwen_lora_xpu.json"
...
set "OUTPUT=%REPO_ROOT%\artifacts\paper1\e3_v2\m0_5_semantic_weighted"
...
if not exist "%EVALUATION%\summary.json" (
    "%PYTHON%" -u -m ccpu paper1 run-asl-pilot ^
        ...
        --adapter-id "Qwen3-0.6B-ASL-Matrix-Q0-SemanticWeighted-r8-seed11" ^
        --condition lora ^
        --shots 0 ^
