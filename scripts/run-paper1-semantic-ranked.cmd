...
set "CONFIG=%REPO_ROOT%\configs\paper1\asl_matrix_q0_semantic_ranked_qwen_lora_xpu.json"
set "DATA=%REPO_ROOT%\artifacts\paper1\e3_v2\m0_6_semantic_ranked\data"
...
set "OUTPUT=%REPO_ROOT%\artifacts\paper1\e3_v2\m0_6_semantic_ranked"
...
if not exist "%EVALUATION%\summary.json" (
    "%PYTHON%" -u -m ccpu paper1 run-asl-pilot ^
        ...
        --adapter-id "Qwen3-0.6B-ASL-Matrix-Q0-SemanticRanked-r8-seed11" ^
        --condition lora ^
        --shots 0 ^
