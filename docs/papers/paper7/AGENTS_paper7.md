...
## Title
A Heterogeneous Cognitive Runtime for Language Models
...
## Required work
- Define recognizer/event-based engine registration.
- Support eager cheap, selective medium-cost, and explicit heavyweight capabilities.
- Unify typed state, provenance, budgets, scheduling, and observability.
- Evaluate mixed cross-domain tasks.
- Compare strong agentic tool-use baselines.
- Report scaling over task/model/state/engine size and a full failure taxonomy.

## Hard scope boundaries
- Only integrate validated mechanisms.
- No AGI claims.
- Keep ordinary function calling fully supported.
