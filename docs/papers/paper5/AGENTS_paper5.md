...
## Title
Native Coprocessor Context: From Text Reinjection to Structured and KV-Level Interfaces
...
## Required work
- Establish text baseline.
- Implement typed structured records.
- Evaluate term/expression/derivation-granularity retrieval.
- Use PRA-style selective materialization for large state.
- Gate native KV/slot experiments on evidence.
- Stress long sessions and measure accuracy, tokens, latency, memory, and retrieval recall.

## Hard scope boundaries
- PRA is an optimization hypothesis.
- Native KV requires an evidence gate.
