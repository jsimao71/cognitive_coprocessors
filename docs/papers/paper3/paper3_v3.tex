...
The registry now also hashes the Paper 1.5 CRAG condition matrix and Paper 2.5
public-suite readiness ledger. Those upstream artifacts validate oracle-timed
generic transport but leave model timing, evidence execution, and final answers
pending. They therefore add provenance, not a completed Paper 3 condition, and
