...
A minimal protocol-only experiment is now configured but remains unrun at this
checkpoint. The training set has 80 arithmetic and 80 negative-control requests;
...
The XPU training gate completed a PEFT forward, backward, and AdamW step on
Qwen3-0.6B. The frozen stack adds PEFT 0.20.0 and Accelerate 1.14.0 to PyTorch
