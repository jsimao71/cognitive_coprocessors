...
and test suite are implemented. A one-checkpoint, one-seed XPU pilot produced
...
does not pass the evidence gate for later mechanisms.
\end{abstract}

\section{Status and Scope}

This document is an implemented experimental protocol with a preliminary pilot,
not a completed confirmatory result.
